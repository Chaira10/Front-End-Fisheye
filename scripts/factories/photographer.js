function photographerFactory(data, index) {
    ...
    function getUserCardDOM() {
        ...
        article.setAttribute('tabindex', `${index}`); // Ajoute l'attribut "tabindex" pour permettre le focus  // Utilise l'index comme valeur tabindex
        ...
        img.setAttribute('tabindex', '0'); // Ajoute l'attribut "tabindex" pour permettre le focus
        ...
        h2.setAttribute('tabindex', '0'); // Ajoute l'attribut "tabindex" pour permettre le focus
        ...
        span1.setAttribute('tabindex', '0'); // Ajoute l'attribut "tabindex" pour permettre le focus
        ...
        p1.setAttribute('tabindex', '0'); // Ajoute l'attribut "tabindex" pour permettre le focus
        ...
        p2.setAttribute('tabindex', '0'); // Ajoute l'attribut "tabindex" pour permettre le focus
    ...
    article.addEventListener('keydown', (event) => {
        ...
        const cardElements = Array.from(article.querySelectorAll('h2, span, p, img, article'));
